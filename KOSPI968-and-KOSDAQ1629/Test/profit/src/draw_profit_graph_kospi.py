...
def predict_dataset(start, end, output, title, topN, isTopN):
    ...
    #probability = [0.625, 0.625, 0.615, 0.625, 0.6]
    probability = [0.625, 0.68, 0.625, 0.5]
    text = [-20, -30, -40, -50, -60, -70]
    color = ['red', 'black', 'blue', 'purple']
    label = ['VGG16 (Train Data : KOSPI)', 'VGG16 (Train Data : KOSPI, KOSDAQ)', 'EfficientNet B7 (Train Data : KOSPI)', 'EfficientNet B7 (Train Data : KOSPI, KOSDAQ)']
    trans = [0, 0]
    ...
    models = []
    # VGG16 - KOSPI
    profit_2019_kospi = pd.read_csv('../profit_csv/test_kospi/test_2019_kospi_vgg16_train_kospi_4%_01_2_Epochs8_Batch128_Dropout25_profit.csv')
    profit_2020_kospi = pd.read_csv('../profit_csv/test_kospi/test_2020_kospi_vgg16_train_kospi_4%_01_2_Epochs8_Batch128_Dropout25_profit.csv')
    profit_2021_kospi = pd.read_csv('../profit_csv/test_kospi/test_2021_kospi_vgg16_train_kospi_4%_01_2_Epochs8_Batch128_Dropout25_profit.csv')
    vgg16_kospi = [profit_2019_kospi, profit_2020_kospi, profit_2021_kospi]
    models.append(vgg16_kospi)
    
    # VGG16 - KOSPI + KOSDAQ
    profit_2019_kosdaq = pd.read_csv('../profit_csv/test_kospi/test_2019_kospi_vgg16_train_kospi_and_kosdaq_Batch128_Epochs8_Dropout20_profit.csv')
    profit_2020_kosdaq = pd.read_csv('../profit_csv/test_kospi/test_2020_kospi_vgg16_train_kospi_and_kosdaq_Batch128_Epochs8_Dropout20_profit.csv')
    profit_2021_kosdaq = pd.read_csv('../profit_csv/test_kospi/test_2021_kospi_vgg16_train_kospi_and_kosdaq_Batch128_Epochs8_Dropout20_profit.csv')
    vgg16_total = [profit_2019_kosdaq, profit_2020_kosdaq, profit_2021_kosdaq]
    models.append(vgg16_total)
    
    # EfficientNet - KOSPI
    profit_2019_kospi_effi = pd.read_csv('../profit_csv/test_kospi/test_2019_kospi_efficientNetB7_train_kospi_Batch64_Dropout30_profit.csv')
    profit_2020_kospi_effi = pd.read_csv('../profit_csv/test_kospi/test_2020_kospi_efficientNetB7_train_kospi_Batch64_Dropout30_profit.csv')
    profit_2021_kospi_effi = pd.read_csv('../profit_csv/test_kospi/test_2021_kospi_efficientNetB7_train_kospi_Batch64_Dropout30_profit.csv')
    effi_kospi = [profit_2019_kospi_effi, profit_2020_kospi_effi, profit_2021_kospi_effi]
    models.append(effi_kospi)

    # EfficientNet - KOSPI, KOSDAQ
    profit_2019_kosdaq_2 = pd.read_csv('../profit_csv/test_kospi/test_2019_kospi_efficientNetB7_train_kospi_and_kosdaq_Batch64_Dropout35_profit.csv')
    profit_2020_kosdaq_2 = pd.read_csv('../profit_csv/test_kospi/test_2020_kospi_efficientNetB7_train_kospi_and_kosdaq_Batch64_Dropout35_profit.csv')
    profit_2021_kosdaq_2 = pd.read_csv('../profit_csv/test_kospi/test_2021_kospi_efficientNetB7_train_kospi_and_kosdaq_Batch64_Dropout35_profit.csv')
    effi_total = [profit_2019_kosdaq_2, profit_2020_kosdaq_2, profit_2021_kosdaq_2]
    models.append(effi_total)
    ...
    plt.text(Date_all[-1], -60, '%.1f%%' %kospi_2021[-1], color='green', ha='center', va='bottom', size = 15)
    plt.text(Date_all[len(kospi_2019) - 1],-60, '%.1f%%' %kospi_2019[-1], color='green', ha='center', va='bottom', size = 15)
    plt.text(Date_all[len(kospi_2019) + len(kospi_2020) - 1], -60, '%.1f%%' %kospi_2020[-1], color='green', ha='center', va='bottom', size = 15)

    # Plotting KOSDAQ Index
    # plt.plot(Date_all, kosdaq_2019, 'olive', label='KOSDAQ INDEX')
    # plt.text(Date_all[-1], -90, '%.1f%%' %kosdaq_2019[-1], color='olive', ha='center', va='bottom', size = 15)
    # plt.text(Date_all[len(kosdaq_2019_real) - 1],-90, '%.1f%%' %kosdaq_2019_real[-1], color='olive', ha='center', va='bottom', size = 15)
    # plt.text(Date_all[len(kosdaq_2019_real) + len(kosdaq_2020) - 1], -90, '%.1f%%' %kosdaq_2020[-1], color='olive', ha='center', va='bottom', size = 15)
